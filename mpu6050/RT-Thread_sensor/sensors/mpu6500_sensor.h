...
#ifndef MPU6500_SENSOR_H__
#define MPU6500_SENSOR_H__
...
#define MPU6500_XG_OFFS_TC          0x00
#define MPU6500_YG_OFFS_TC          0x01
#define MPU6500_ZG_OFFS_TC          0x02
#define MPU6500_X_FINE_GAIN         0x03
#define MPU6500_Y_FINE_GAIN         0x04
#define MPU6500_Z_FINE_GAIN         0x05
#define MPU6500_XA_OFFS_H           0x06
#define MPU6500_XA_OFFS_L           0x07
#define MPU6500_YA_OFFS_H           0x08
#define MPU6500_YA_OFFS_L           0x09
#define MPU6500_ZA_OFFS_H           0x0A
#define MPU6500_ZA_OFFS_L           0x0B
#define MPU6500_PRODUCT_ID          0x0C
...
#define MPU6500_XG_OFFS_USRH        0x13
#define MPU6500_XG_OFFS_USRL        0x14
#define MPU6500_YG_OFFS_USRH        0x15
#define MPU6500_YG_OFFS_USRL        0x16
#define MPU6500_ZG_OFFS_USRH        0x17
...
class MPU6500 : public SensorBase
{
public:
    MPU6500(int sensor_type, const char* iic_bus, int addr);
...
class MPU6500_Accelerometer: public MPU6500
{
public:
    MPU6500_Accelerometer(const char* iic_name, int addr);
...
class MPU6500_Gyroscope: public MPU6500
{
public:
    MPU6500_Gyroscope(const char* iic_name, int addr);
